...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cheap_repr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14154&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cheap_repr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cheap_repr` can be installed with:

```
conda install cheap_repr
```

It is possible to list all of the versions of `cheap_repr` available on your platform with:
